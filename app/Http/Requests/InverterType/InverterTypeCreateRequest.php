...
class InverterTypeCreateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name'=>'required|string|max:255|unique:inverter_types,name',
    ...
    public function messages()
    {
        return [
            ...
            'name.unique' => 'This inverter name already exists.',
